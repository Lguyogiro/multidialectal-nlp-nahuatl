...
- If you have the Western Sierra and Highland Puebla Nahuatl UD treebanks downloaded, just update the paths in `data_creation_script.sh` to point to them, and run that.
